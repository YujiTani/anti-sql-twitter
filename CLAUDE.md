...
5. **エラー発生時は必ずエラー報告レポートを作成**
   - REPORT.mdのテンプレートに従って構造化されたレポートを作成
   - エラー状況・根本原因・改修提案を含む包括的な分析を提供
   - 相談通知を送信してユーザーの承認を得てから改修実行```
...
- **必須レポート作成**: エラー発生時はREPORT.mdテンプレートに従った構造化レポートを必ず作成
- **包括的分析**: エラー状況・根本原因・段階的改修提案を含む完全な分析を提供
- **事前承認制**: 相談通知送信後、ユーザー承認を得てから改修作業を実行
